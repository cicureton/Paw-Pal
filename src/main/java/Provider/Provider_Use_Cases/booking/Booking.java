...
import Provider.Provider_Use_Cases.customer.Customer;
import Provider.Provider_Use_Cases.petService.PetService;
...
public class Booking {
    ...
    public String toString() {
        return "Booking{" +
                ...
                ", petService=" + (petService != null ? petService.getTitle() : "null") +
                '}';
    }
}
